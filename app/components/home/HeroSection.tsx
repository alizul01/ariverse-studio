...
export default function HeroSection() {
  return (
    <section className="relative min-h-[calc(100vh-5rem)] overflow-hidden py-8 md:py-10 pb-0">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 md:px-6 flex flex-col-reverse lg:flex-row items-center gap-4">

        {/* Left column: Text */}
        <div className="flex flex-col items-center lg:items-start gap-3 md:gap-4 w-full lg:w-3/5 text-center lg:text-left">
        ...
        <motion.div
          ...
          className="flex items-center gap-2.5 md:gap-3 mt-1 flex-wrap justify-center lg:justify-start"
        >
          <Link
            href="/games"
        ...
        <motion.div
          ...
          className="flex items-center divide-x divide-foreground/10 bg-background/75 backdrop-blur-md border border-foreground/10 rounded-xl md:rounded-2xl px-1 md:px-2 py-1.5 md:py-2 shadow-[0_4px_24px_rgba(0,0,0,0.06)] mt-3"
        >
          {[
            { num: "3+", label: "Games" },
      ...
      {/* Right column: Image */}
      <div className="relative z-10 w-full lg:w-2/5 flex justify-center">
        <motion.div
        ...
        >
          <Image
            src="/images/Key-Characters-Creatures.png"
